<div id="commentsPoster">
    @foreach($commentsParent as $commentParent)
        <div class="divCommentParent" id="{{$commentParent->id}}">
            ...
            <a href="#formComment"><button class="buttonCommentChild" type="button" data-id="{{$commentParent->id}}">Répondre</button>
            </a>
...
<form id="formComment" action="{{route('addAjaxComment')}}" method="POST" data-id="{{$post->id}}">
    @csrf
    ...
    <button id="buttonCancelComment" type="button">Annuler</button>
</form>
